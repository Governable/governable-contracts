...
// Based on https://github.com/compound-finance/compound-protocol/blob/master/contracts/Governance/GovernorBravoInterfaces.sol
...
contract GovernorStorage {
    ...
    /// @notice The slot number of the mapping in the voting token for calculating slots per account
    uint256 public mappingSlotNumber;
